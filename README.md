...
```sh
git clone https://github.com/HajarMoumine/test.git
cd test
...
| Name | E-mail     |
|------|------------|
| cruft create https://github.com/FAIRmat-NFDI/cookiecutter-nomad-pv-pluginHajar Moumine | [hajar.moumine@helmholtz-berlin.de](mailto:hajar.moumine@helmholtz-berlin.de)
